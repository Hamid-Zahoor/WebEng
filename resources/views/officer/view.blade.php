...
<div class="container">
    <div class="row justify-content-center">
        ...
        <legend style="color: green; font-weight: bold;">LARAVEL 7.X CRUD EXAMPLE - CODECHIEF
           <a href="{{ route('customer.list') }}" style="float: right; display: block;color: white; background-color: green; padding: 1px 5px 1px 5px; text-decoration: none; border-radius: 5px; font-size: 17px;"> OFFICER LIST</a>
          </legend>
            ...
            <div class="form-group" style="margin-top: 24px;">
              <a href="{{ route('officer.list') }}" class="btn btn-success">Back</a>
            </div>
        </div>
    </div>
</div>
